...
public class RotateBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
    ...
    private static final String LOG_TAG = RotateBehavior.class.getSimpleName();
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        float translationY = getFabTranslationForSnackbar(parent, child);
    ...
    private float getFabTranslationForSnackbar(CoordinatorLayout parent, FloatingActionButton fab) {
        float minOffset = 0;
